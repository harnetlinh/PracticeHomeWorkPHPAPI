...
class UserController{
    ...
    private function storeFile(){
        try {
            ...
            $upload_path = 'E:\CODE\300-Bai-Code-Thieu-Nhi\50-Bai-Code-PHP\API-sample\uploaded/'; // set upload folder path 
            ...
            if(in_array($fileExt, $valid_extensions))
            {
                ...
                {
                    if($fileSize < 5000000){
                        $result = move_uploaded_file($tempPath, $upload_path . $fileName); // move file from system temporary path to our upload folder path 
                        if ($result) {
                            return $fileName;
                        }else{
                            return false;
